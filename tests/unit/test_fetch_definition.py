...
def test_word_not_found():
    ...
    result = fetch_definition(nonsense)
...
def test_top_n_controls_number_of_senses():
    ...
    _skip_if_wordnet_missing()
    result = fetch_definition("run", top_n=3)
...
def test_max_synonyms_cap():
    ...
    _skip_if_wordnet_missing()
    max_syn = 3
    result = fetch_definition("happy", max_synonyms=max_syn)
...
def test_no_examples_when_disabled():
    ...
    _skip_if_wordnet_missing()
    result = fetch_definition("run", include_examples=False)
